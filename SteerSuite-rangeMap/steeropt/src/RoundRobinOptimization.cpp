...
void RoundRobinOptimization::optimize()
{
	...
	RoundRobinCMA<libcmaes::GenoPheno<libcmaes::pwqBoundStrategy, libcmaes::linScalingStrategy>> optim(_diversity_members, func, cmaparams);
	...
	while (!optim.stop())
	{
		...
		*/
		...
		if (this->_logger && (optim._round > 1) ) ///////////////OVERHEAD/////////////////
		{
...
// get_fvalue();
	...
	Util::Recorder::instance()->record("3rritr", round);
