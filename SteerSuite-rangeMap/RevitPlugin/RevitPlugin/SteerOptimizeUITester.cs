...
{   
    ...
    class SteerOptimizeUITester : Autodesk.Revit.UI.IExternalCommand
    {
        ...
        private bool runMode = true; //if devMode is false then runMode true represents Study-C and runMode false represents Study-B
        private bool devMode = true; //represents dev mode. If true then ignore runMode
        ...
        public void ShowForm(Document doc, UIApplication uiapp)
        {
            ...
            if (r_UI_Form == null || r_UI_Form.IsDisposed)
            {
                ...
                if(runModeA)
                    ...
                    r_UI_Form = handler.InitializeForm(doc, exEvent, runMode, devMode); //if devMode is true then ignore runMode otherwise runMode true represents Study-C and runMode false represents Study-B
        ...
        public void userStudyC_Click(object sender, EventArgs e)
        {
            runMode = true; //Study-C
            devMode = false;
            if (initialForm != null && initialForm.Visible)
            {
                initialForm.Close();
        ...
        public System.Windows.Forms.Form ShowInitialForm(Document doc, UIApplication uiapp)
        {
            ...
            System.Windows.Forms.Button userStudyC = new System.Windows.Forms.Button();
            ...
            userStudyC.Location = new System.Drawing.Point(590, 80);
            userStudyC.Name = "userStudyC";
            userStudyC.Size = new System.Drawing.Size(260, 40);
            userStudyC.TabIndex = 2;
            userStudyC.Text = "Study-C";
            userStudyC.UseVisualStyleBackColor = true;
            userStudyC.Font = new System.Drawing.Font("Microsoft Sans Serif", 11.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            userStudyC.Click += new System.EventHandler(userStudyC_Click);
            ...
            dev.Location = new System.Drawing.Point(310, 140);
            dev.Name = "dev";
