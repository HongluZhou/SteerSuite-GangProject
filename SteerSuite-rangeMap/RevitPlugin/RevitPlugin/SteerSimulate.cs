...
namespace RevitPlugin
{
    ...
    class SteerSimulate : Autodesk.Revit.UI.IExternalCommand
    {
        /// <summary>
        ...
        public Autodesk.Revit.UI.Result Execute(ExternalCommandData cmdData, ref string msg, ElementSet eleSet)
        {
            ...
            try
            {
                ...
                steersuite.finish();
                System.IO.StreamWriter file = new System.IO.StreamWriter("C:\\Users\\usman\\Downloads\\Crowds\\SteerSuite\\build\\bin\\test.txt");
