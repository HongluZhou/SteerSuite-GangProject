...
// if you want situation agents define this
//#define SITUATION_AGENT
...
namespace RVO {
  ...
  public:
    ...
    */
	...
	/*** MWS - added functions for my parameters ***/
	void setAgentAlpha(int id, float alpha);
	float getAgentAlpha(int id) const;

	void setAgentActive(int id, bool act);
	bool getAgentActive(int id) const;
	
	void setObstAgent(int i);
	bool isObstGroupAgent(int i) const;

	bool setFormAgentMembers(const std::vector<int> &agents);

	std::vector<int> getGroupMetaAgentIDs(void) const;
	std::vector<int> getFormMetaAgentIDs(void) const;

	void reserveMetaAgents(int numGroupMetaAgents, int numFormMetaAgents, const Vector2& startPosition, int goalID,
  ...
  private:
    ...
    */
	...
	/*** MWS - added group agents ***/
	int _numGroupMetaAgents;
	int _numFormMetaAgents;
	void setGroupAgent(int i);
	void setFormAgent(int i);
	/*********************************************/
