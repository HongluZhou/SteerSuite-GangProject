...
static void  processMouseMovementEvent(double x, double y) { GLFWEngineDriver::getInstance()->processMouseMovementEvent(x,y); }
...
void GLFWEngineDriver::processMouseMovementEvent(double x, double y)
{
	...
	// get mouse changes
	double deltaX = x - _mouseX;
	double deltaY = y - _mouseY;
